      ...
      <div className="flex justify-center">
        ...
        <div className="flex flex-col items-center bg-green-700 border-dashed border-[#66FF00] border-4 text-white p-6 rounded-lg w-1/3 mx-4">
          ...
          <p className="text-center font-semibold text-lg leading-relaxed">
            Insertion Sort is a step-by-step algorithm that helps arrange elements by building a 
            sorted list one item at a time. Imagine holding a deck of cards and sorting them in your 
            hand: you take each card and insert it into its correct position. That is exactly how this
            algorithm works!
          </p>
        </div>
        ...
        <div className="flex flex-col items-center bg-green-700 border-dashed border-[#66FF00] border-4 text-white p-6 rounded-lg w-1/3 mx-4">
          ...
          <div className="w-full h-48 bg-black flex items-center justify-center rounded-md relative">
            ...
            <video
              ...
              src="/insertionsort-tutorial-video.mp4"
              type="video/mp4"
              controls
              autoPlay
            />
          ...
          {/* Next Button */}
          <Link href="/insertionsortPractise">
...
export default InsertionSortTutorial;
